...
sys.path.append("FULL PATH TO PROJECT FOLDER")
...
SECRET_KEY = 'django-insecure-t1-05pjhof3k^^zx3b(&d(h*i*eodgfsc8!x5xbxt5_#lvn4%w'
...
INSTALLED_APPS = [
    'django_project.telegrambot.manager',
